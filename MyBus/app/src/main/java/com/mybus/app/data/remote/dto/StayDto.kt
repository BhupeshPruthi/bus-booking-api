...
data class StayBookingItem(
    ...
    @Json(name = "quantity") val quantity: Int,
    @Json(name = "capacityPerUnit") val capacityPerUnit: Int? = null,
    @Json(name = "nightlyRate") val nightlyRate: Double,
    @Json(name = "nightCount") val nightCount: Int,
...
@JsonClass(generateAdapter = true)
data class UpdateStayUnitTypeRequest(
    @Json(name = "nightlyRate") val nightlyRate: Double,
    @Json(name = "changeNote") val changeNote: String? = null
)
...
@JsonClass(generateAdapter = true)
data class UpdateAdminTypeRequest(
    @Json(name = "adminType") val adminType: String,
